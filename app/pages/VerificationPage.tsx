      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-4 sm:p-6 md:p-8 relative max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-center mb-4 sm:mb-6 md:mb-8">
          <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-brand-300 to-brand-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
            <CheckCircle2 className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-brand-500" />
          </div>
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <div className={`p-2 sm:p-3 rounded-xl ${emailVerified ? 'bg-green-100' : 'bg-brand-100'}`}>
              <Mail className={`w-4 h-4 sm:w-5 sm:h-5 ${emailVerified ? 'text-green-600' : 'text-brand-500'}`} />
            </div>
          ...
          {!emailVerified && (
            <>
              ...
              <button
                ...
                disabled={isChecking}
                className="w-full bg-brand-500 text-white py-2.5 sm:py-3 rounded-xl text-sm sm:text-base font-semibold hover:bg-brand-700 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed mb-3"
              >
              ...
              <div className="text-center">
                {emailResendTimer > 0 ? (
                  ...
                  <button
                    ...
                    className="text-xs sm:text-sm text-brand-500 hover:underline font-medium flex items-center gap-1 mx-auto"
                  >
