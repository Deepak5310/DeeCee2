    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 min-h-screen">
      ...
      {confirmed ? (
        <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-lg">
          ...
          {calendarLink && (
            <div className="bg-gradient-to-r from-brand-100 to-blue-50 border border-brand-300 rounded-xl p-4 mb-6">
              ...
              <a
                ...
                className="inline-block bg-brand-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-brand-700 transition text-sm"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={resetForm}
              className="flex-1 bg-brand-500 text-white px-6 py-3 rounded-2xl font-semibold hover:bg-brand-700 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
        ...
        <form onSubmit={handleConfirm} className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <h3 className="font-bold text-lg text-gray-900 mb-6 flex items-center gap-2">
              <span className="bg-brand-300 text-brand-500 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">1</span>
              Your Preferences
            </h3>
            <div className="mb-6">
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
              />
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <h3 className="font-bold text-lg text-gray-900 mb-6 flex items-center gap-2">
              <span className="bg-brand-300 text-brand-500 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">2</span>
                  ...
                  className={`px-4 py-3 rounded-xl border text-sm font-semibold transition-all duration-300 ${
                    slot.disabled
                      ...
                      : selectedTime === slot.time
                        ? "border-brand-500 bg-brand-500 text-white shadow-lg transform scale-105"
                        : "border-gray-300 text-gray-700 hover:border-brand-500 hover:bg-brand-100 hover:shadow-md"
                  }`}
                >
                  {slot.time}
                </button>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <h3 className="font-bold text-lg text-gray-900 mb-6 flex items-center gap-2">
              <span className="bg-brand-300 text-brand-500 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">3</span>
            ...
            <div className="space-y-5">
              ...
              <div className="w-full">
                ...
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all resize-none"
                />
            ...
            <button
              ...
              className={`mt-6 w-full py-4 rounded-2xl font-bold text-base transition-all shadow-lg flex items-center justify-center gap-2 ${
                Object.keys(formErrors).length > 0 || isSubmitting
                  ...
                  : "bg-gradient-to-r from-[#A88B6A] to-brand-1000 text-white hover:from-[#6B5744] hover:to-[#8B7355] hover:shadow-xl transform hover:-translate-y-0.5"
              }`}
            ...
            {isSubmitting && (
              <p className="text-xs text-brand-500 text-center mt-2 animate-pulse">
