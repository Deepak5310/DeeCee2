      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-brand-500 text-white rounded-lg hover:bg-brand-700 transition-colors flex items-center gap-2"
          >
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-brand-500 font-bold mb-2">{formatCurrency(product.price)}</p>
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-brand-500 mb-4">{formatCurrency(selectedProduct.price)}</p>
            ...
            <form onSubmit={handleSubmitProduct} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 px-4 py-2 bg-brand-500 text-white rounded-lg hover:bg-brand-700 transition-colors disabled:opacity-50"
                >
